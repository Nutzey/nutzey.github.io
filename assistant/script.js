...
function processResult(result) {
    ...
    if (typeof query === 'undefined') {
        var answer = "I can't understand your question.";
    ...
    var link0 = "https://en.wikipedia.org/api/rest_v1/page/summary/" + encodeURI(query);
    console.log(link0);
    ...
    fetch(link0)
        ...
        .then(result0 => {
            if (result0.type === 'standard') {
                ...
                var answer = "Could you try to be more specific about \"" + query + "\"?";
                ...
                fetch("https://api.dictionaryapi.dev/api/v2/entries/en/" + encodeURI(query))
                    .then(response1 => {
                        if(!response1.ok) {
                            var answer = "I don't know anything about \"" + query + "\".";
                    ...
                    .then(result1 => {
                        if (typeof result1.message === 'undefined') {
                            ...
                            var answer = "The meaning of \"" + query + "\" is " + meaning + ".";
